...
class ProcessOrder implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        Mail::to($adminMail)->cc(['kalaivani@ejindia.com','marketing.corp@ejindia.com','poornima.m@ejindia.com'])->bcc('sundaram@brightbridgeinfotech.com')->send(new RetailerOrderMail($datas, $excelFilePath, $pdfFilePath));
        ...
        $mobileNumbers = ['9789464745', '8220017619'];
